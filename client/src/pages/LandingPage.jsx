...
import { LayoutDashboard, ArrowRight, Zap, Target, Lock, Calendar } from 'lucide-react';
...
export default function LandingPage() {
  return (
    <div className="landing-page" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      <header className="app-header animate-fade-in-up" style={{ position: 'relative', background: 'transparent', border: 'none', flexWrap: 'wrap', gap: '0.75rem' }}>
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: 'clamp(2rem, 5vw, 4rem) 1.25rem' }}>
        <h1 className="animate-fade-in-up delay-100" style={{ fontSize: 'clamp(2rem, 6vw, 4rem)', fontWeight: 800, marginBottom: '1.5rem', background: 'linear-gradient(to right, #f8f8f2, #a2aab8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
          Manage Chaos, <br/>
        ...
        <p className="animate-fade-in-up delay-200" style={{ fontSize: '1.25rem', color: 'var(--text-muted)', maxWidth: '600px', marginBottom: '3rem', lineHeight: '1.6' }}>
        ...
        <div className="animate-fade-in-up delay-300" style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap', justifyContent: 'center', marginTop: '2rem' }}>
          <FeatureCard 
          ...
          />
          <FeatureCard 
            icon={<Calendar size={32} color="var(--accent-indigo)" />} 
            title="Multiple Views" 
            desc="Effortlessly toggle between Kanban and beautiful time-grid Calendar views." 
          />
        </div>

        <section className="animate-fade-in-up delay-400" style={{ marginTop: '6rem', maxWidth: '1000px', width: '100%', textAlign: 'left' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '3rem', marginBottom: '6rem' }}>
            ...
            <div style={{ flex: '1 1 400px' }}>
              <img src={kanbanGraphic} className="animate-float" alt="Aesthetic Kanban Board" style={{ width: '100%', borderRadius: '16px', boxShadow: '0 10px 30px rgba(6, 182, 212, 0.2)', border: '1px solid var(--panel-border)' }} />
            </div>
          </div>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '3rem', flexDirection: 'row-reverse' }}>
            ...
            <div style={{ flex: '1 1 400px', display: 'flex', justifyContent: 'center' }}>
              <img src={telegramGraphic} className="animate-float" style={{ animationDelay: '1s', width: '100%', borderRadius: '16px', boxShadow: '0 10px 30px rgba(99, 102, 241, 0.2)', border: '1px solid var(--panel-border)' }} alt="Telegram Integration Notification" />
            </div>
          </div>
        </section>
      </main>
